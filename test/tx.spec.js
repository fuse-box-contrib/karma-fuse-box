(function(FuseBox){FuseBox.$fuse$=FuseBox;
  FuseBox.pkg("default", {}, function(___scope___){
    ___scope___.file("t2.spec.js", function(exports, require, module, __filename, __dirname){

      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var one_1 = require("./fixtures/one");
      describe('t2', function () {
        describe('Fixture 2', function () {
          it('should be defined', function () {
            expect(one_1.default).toBeDefined();
          });
          it('should return dependency signature', function () {
            expect(one_1.default()).toBe('1ab');
          });
        });
      });
      //# sourceMappingURL=t2.spec.js.map
    });
    ___scope___.file("fixtures/one.js", function(exports, require, module, __filename, __dirname){

      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var a_1 = require("./modules/a");
      var b_1 = require("./modules/b");
      function one() {
        return '1' + a_1.default() + b_1.default();
      }
      exports.default = one;
      //# sourceMappingURL=one.js.map
    });
    ___scope___.file("fixtures/modules/a.js", function(exports, require, module, __filename, __dirname){
    ...
    ___scope___.file("fixtures/modules/b.js", function(exports, require, module, __filename, __dirname){
